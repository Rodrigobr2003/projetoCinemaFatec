...
int main(){
	...
	int COLUNAS = 5, FILEIRAS = 5, assentos[FILEIRAS][COLUNAS], coluna , fileira, posicao[1][1];
	...
	do{	
		...
		do{
			if(assentos[coluna-1][fileira-1] == 1){
		...
		if(tipoIngresso == 1) contInt += 1;
		if(tipoIngresso == 2) contMei += 1;
		if(tipoIngresso == 3) contCor += 1;
